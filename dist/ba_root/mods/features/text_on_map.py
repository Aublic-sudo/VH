...
def top_message(self, text):
    ...
    node = _ba.newnode('text',
                        attrs={
                            'text':u'\ue048  \ue048', 'flatness':1.0, 'h_align':'center', 'v_attach':'top', 'h_attach':'center', 'scale':0.75, 'position':(400,-35), 'color':(1,1,1)}) ba.animate_array( node, "color", 3, { 0: (1,0,0), 0.2: (1,0.5,0), 0.4: (1,1,0), 0.6: (0,1,0), 0.8: (0,1,1), 1.0: (1,0,1), 1.2: (1,0,0), }, loop=True, )
